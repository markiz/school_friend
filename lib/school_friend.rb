...
module SchoolFriend
  REST_NAMESPACES = %w[auth callbacks discussions events friends group messages notifications payment photos photos_v2 share stream stream url users widget].freeze
...
require 'school_friend/rest/group'
